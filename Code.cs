...

{
...

    {
...

        {
            ...
            nonTeachingStaffList.Add(new NonTeachingStaff(name, username, password, phoneNumber, email, gender, dateOfBirth));

            Console.Write("NON-TEACHING STAFF REGISTRATION SUCCESFUL!\n");

        }

        static void NonTeachingStaffLogin()

        {

            Console.ForegroundColor = ConsoleColor.Green;

            Console.WriteLine("\t\t\t\t\tLOGIN FOR NON-TEACHING STAFFFF!");
            ...
            NonTeachingStaff nonTeachingStaff = nonTeachingStaffList.Find(nts => nts.Username == username && nts.Password == password);
...

            {
                ...
                NonTeachingStaffMenu(nonTeachingStaff);
        ...
        static void NonTeachingStaffMenu(NonTeachingStaff nonTeachingStaff)

        {
...

            {
                ...
                Console.WriteLine("\t\t\t\t\tNON-TEACHING STAFF MENU ");
...

                {
                    ...
                    case "1":
                        ...
                        nonTeachingStaff.DisplayProfile();
...

        {
            ...
            Console.WriteLine("\t\t\t\t\tWELCOME TO HOD REGISTRATION PORTAL ");
        ...
        static void RegisterHOD()

        {

            Console.ForegroundColor = ConsoleColor.Yellow;

            Console.WriteLine("\t\t\t\t\t HOD REGISTRATION PORTAL ");
            ...
            hodList.Add(new HOD(name, username, password, phoneNumber, email, dateOfBirth));

            Console.Write("\t\t\t\t\tHOD REGISTRATION SUCCESFUL!\n");

        }

        static void LoginHOD()
...

                    {
                        ...
                        case "2":
...

                            {
                                ...
                                Console.WriteLine("STUDENTS NOT REGISTERED .");
                        ...
                        case "3":
...

                            {
                                ...
                                Console.WriteLine("TEACHING STAFF NOT REGISTERED.");
...

                            {
                                ...
                                Console.WriteLine("N0N-TEACHING STAFF NOT REGISTERED.");
                        ...
                        case "6":
                            ...
                            Console.WriteLine("RETURNINNG TO MENU");
...

        {
            ...
            Console.WriteLine("\t\t\t\t\tWELCOME TO  COE REGISTRATION PORTAL ");

            Console.ForegroundColor = ConsoleColor.Cyan;

            Console.WriteLine("────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── ");

            Console.WriteLine("\t1. REGISTER COE\n\t2. LOGIN\n\t3. EXIT");
...

            {
                ...
                case "3":
                    ...
                    Console.WriteLine("RETURNING TO BACK .");
        ...
        static void RegisterCOE()

        {

            Console.ForegroundColor = ConsoleColor.Red;

            Console.WriteLine("\t\t\t\t\t  COE REGISTRATION PORTAL ");
            ...
            coeList.Add(new COE(name, username, password, phoneNumber, email, dateOfBirth));

            Console.WriteLine("COE REGISTRATION SUCCESFUL!\n");

        }

        static void LoginCOE()

        {
...

                    {
                        ...
                        case "3":
...

                            {
                                ...
                                Console.WriteLine("HOD NOT REGISTERED.");
...

            {
                ...
                Console.Write("Invalid username or password. Please try again.\n");
        ...
        static void ViewTeachingStaffList()

        {

            Console.Write("LIST OF TEACHING STAFF :");
        ...
        static void ViewNonTeachingStaffList()

        {

            Console.Write("LIST OF NON-TEACHING STAFF :");

            foreach (var staff in nonTeachingStaffList)
...

        {
            ...
            Console.WriteLine("ENTER STUDENT USERNAME TO UPDATE :");

            string username = Console.ReadLine();

            Student studentToUpdate = students.Find(s => s.Username == username);
...

            {
                ...
                // Implement code to update student profile
                ...
                studentToUpdate.Password = Console.ReadLine();
                ...
                studentToUpdate.DateOfBirth = newDateOfBirth;

                Console.ForegroundColor = ConsoleColor.Green;

                Console.Write("STUDENT PROFILE UPDATED SUCCESSFULLY!\n");
...

        {
            ...
            Console.Write("ENTER STUDENT USER NAME TO DELETE:");

            string username = Console.ReadLine();

            Student studentToDelete = students.Find(s => s.Username == username);
...

            {
                ...
                Console.Write("STUDENT DELETED SUCCESFULLY!\n");
        ...
        static void UpdateTeachingStaffProfile()

        {

            Console.WriteLine("ENTER TEACHING STAFF USERNAME TO UPDATE:");

            string username = Console.ReadLine();

            TeachingStaff staffToUpdate = teachingStaffList.Find(s => s.Username == username);
...

            {
                ...
                // Implement code to update teaching staff profile

                Console.Write("ENTER NEW NAME                           :");

                staffToUpdate.Name = Console.ReadLine();

                Console.Write("ENTER NEW PASSWORD                       :");

                staffToUpdate.Password = Console.ReadLine();

                Console.Write("ENTER NEW PHONE NUMBER                   :");

                staffToUpdate.PhoneNumber = Console.ReadLine();

                Console.Write("ENTER NEW E-MAIL                         :");

                staffToUpdate.Email = Console.ReadLine();
                ...
                staffToUpdate.DateOfBirth = newDateOfBirth;


                Console.Write("TEACHING STAFF PROFILE UPDATED SUCCESSFULLY!\n");
...

            {
                ...
                Console.Write("TEACHING STAFF NOT FOUND.\n");

            }

        }

        static void DeleteTeachingStaff()

        {

            Console.Write("ENTER TEACHING STAFF USERNAME TO DELETE :");

            string username = Console.ReadLine();

            TeachingStaff staffToDelete = teachingStaffList.Find(s => s.Username == username);
...

            {
                ...
                teachingStaffList.Remove(staffToDelete);

                Console.Write("TEACHING STAFF DELETED SUCCESSFULLY !\n");
        ...
        static void UpdateNonTeachingStaffProfile()

        {

            Console.Write("ENTER NON-TEACHING FACULTY TO UPDATE:");

            string username = Console.ReadLine();

            NonTeachingStaff staffToUpdate = nonTeachingStaffList.Find(s => s.Username == username);
...

            {
                ...
                // Implement code to update non-teaching staff profile
                ...
                Console.Write("NON-TEACHING STAFF PROFILE UPDATED SUCCESSFULLY !\n");
...

            {
                ...
                Console.Write("Non-TEACHING STAFF NOT FOUND.\n");

            }

        }

        static void DeleteNonTeachingStaff()

        {

            Console.Write("ENTER NON-TEACHING STAFF USERNAME TO DELETE :");

            string username = Console.ReadLine();

            NonTeachingStaff staffToDelete = nonTeachingStaffList.Find(s => s.Username == username);
...

            {
                ...
                nonTeachingStaffList.Remove(staffToDelete);

                Console.Write("NON-TEACHING STAFF DELETED SUCCESSFULLY !\n");
        ...
        static void UpdateHODProfile()

        {

            Console.Write("ENTER HOD USERNAME TO UPDATE              :");

            string username = Console.ReadLine();

            HOD hodToUpdate = hodList.Find(h => h.Username == username);
...

            {
                ...
                // Implement code to update HOD profile

                Console.Write("ENTER NEW NAME                        :");

                hodToUpdate.Name = Console.ReadLine();

                Console.Write("ENTER NEW PASSWORD                    :");

                hodToUpdate.Password = Console.ReadLine();

                Console.Write("ENTER NEW PHONE NUMBER                :");

                hodToUpdate.PhoneNumber = Console.ReadLine();

                Console.Write("ENTER NEW E-MAIL                      :");

                hodToUpdate.Email = Console.ReadLine();

                Console.Write("ENTER NEW DAATE ODF BIRTH (YYYY-MM-DD):");
                ...
                hodToUpdate.DateOfBirth = newDateOfBirth;


                Console.Write("HOD PROFILE UPDATED SUCCESSFULLY !\n");
...

            {
                ...
                Console.Write("HOD NOT FOUND.\n");

            }

        }

        static void DeleteHOD()

        {

            Console.Write("ENTER HOD USERNAME TO DELETE:");

            string username = Console.ReadLine();

            HOD hodToDelete = hodList.Find(h => h.Username == username);
...

            {
                ...
                hodList.Remove(hodToDelete);

                Console.Write("HOD DELETED SUCCESSFULLY !\n");
...

            {
                ...
                Console.WriteLine("HOD NOT FOUND.\n");

            }

        }

        static void UpdateCOEProfile()

        {
            ...
            Console.Write("ENTER COE USERNAME TO UPDATE :");

            string username = Console.ReadLine();

            COE coeToUpdate = coeList.Find(c => c.Username == username);
...

            {
                ...
                // Implement code to update COE profile

                Console.Write("\tENTER NEW NAME                         :");

                coeToUpdate.Name = Console.ReadLine();

                Console.Write("\tENTER NEW PASSWORD                     :");

                coeToUpdate.Password = Console.ReadLine();

                Console.Write("\tENTER NEW PHONE NUMBER                 :");

                coeToUpdate.PhoneNumber = Console.ReadLine();

                Console.Write("\tENTER NEW EMAIL                        :");

                coeToUpdate.Email = Console.ReadLine();
                ...
                coeToUpdate.DateOfBirth = newDateOfBirth;


                Console.WriteLine("\t\t\tCOE PROFILE UPDATED SUCESSFULLY!\n");
...

            {
                ...
                Console.WriteLine("COE NOT FOUND.\n");

            }

        }

        static void DeleteCOE()

        {

            Console.Write("ENTER COE USERNAME TO DELETE:");

            string username = Console.ReadLine();

            COE coeToDelete = coeList.Find(c => c.Username == username);
...

            {
                ...
                coeList.Remove(coeToDelete);

                Console.Write("COE DELETED SUCCESFULLY!\n");
        ...
        static void UpdateHOIProfile()

        {

            Console.Write("ENTER HOI USERNAME TO UPDATE :");

            string username = Console.ReadLine();

            HOI hoiToUpdate = hoiList.Find(h => h.Username == username);
...

            {
                ...
                // Implement code to update HOI profile

                Console.Write("ENTER NEW NAME                   :");

                hoiToUpdate.Name = Console.ReadLine();

                Console.Write("ENTER NEW PASSCODE               :");

                hoiToUpdate.Password = Console.ReadLine();

                Console.Write("ENTER NEW PHONE NUMBER           :");

                hoiToUpdate.PhoneNumber = Console.ReadLine();

                Console.Write("ENTER NEW E-MAIL                 :");

                hoiToUpdate.Email = Console.ReadLine();
                ...
                hoiToUpdate.DateOfBirth = newDateOfBirth;


                Console.Write("HOI PROFILE UPDATED SUCCESSFULLY !\n");
...

            {
                ...
                Console.Write("HOI not found.\n");

            }

        }

        static void DeleteHOI()

        {

            Console.Write("ENTER HOI USERNAME TO DELETE :");

            string username = Console.ReadLine();

            HOI hoiToDelete = hoiList.Find(h => h.Username == username);
...

            {
                ...
                hoiList.Remove(hoiToDelete);

                Console.WriteLine("HOI DELETED SUCCESFULLY!\n");
...

            {
                ...
                Console.WriteLine("HOI not found.\n");
